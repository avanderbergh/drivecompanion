...
},{"../parsers/directive":62,"../parsers/expression":63,"../parsers/path":64,"../parsers/text":66,"../util":74,"../watcher":78}],13:[function(require,module,exports){
var _ = require('../util')
...
},{"../transition":67,"../util":74}],14:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":74}],15:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../compiler":21,"../config":23,"../directives/internal":30,"../fragment/factory":52,"../parsers/directive":62,"../parsers/expression":63,"../parsers/path":64,"../parsers/template":65,"../parsers/text":66,"../util":74,"_process":2}],16:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../compiler":21,"../util":74,"_process":2}],17:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
...
},{"./config":23,"./util":74,"_process":2}],18:[function(require,module,exports){
/**
...
},{"../config":23,"../directives/internal/prop":31,"../parsers/directive":62,"../parsers/path":64,"../util":74,"_process":2}],20:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../directives/internal":30,"../directives/public":40,"../parsers/directive":62,"../parsers/template":65,"../parsers/text":66,"../util":74,"./compile-props":19,"_process":2}],21:[function(require,module,exports){
var _ = require('../util')

_.extend(exports, require('./compile'))
_.extend(exports, require('./transclude'))

},{"../util":74,"./compile":20,"./transclude":22}],22:[function(require,module,exports){
(function (process){
var _ = require('../util')
var templateParser = require('../parsers/template')
var specialCharRE = /[^\w\-:\.]/
...
},{"../parsers/template":65,"../util":74,"_process":2}],23:[function(require,module,exports){
module.exports = {
...
},{"./parsers/text":66}],24:[function(require,module,exports){
(function (process){
var _ = require('./util')
var Watcher = require('./watcher')
var expParser = require('./parsers/expression')
...
},{"./parsers/expression":63,"./util":74,"./watcher":78,"_process":2}],25:[function(require,module,exports){
exports.slot = require('./slot')
exports.partial = require('./partial')

},{"./partial":26,"./slot":27}],26:[function(require,module,exports){
(function (process){
var _ = require('../../util')
...
},{"../../fragment/factory":52,"../../util":74,"../public/if":39,"_process":2}],27:[function(require,module,exports){
var _ = require('../../util')
var templateParser = require('../../parsers/template')
...
},{"../../parsers/template":65,"../../util":74}],28:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../parsers/template":65,"../../util":74,"_process":2}],30:[function(require,module,exports){
...
},{"./class":28,"./component":29,"./prop":31,"./style":32,"./transition":33}],31:[function(require,module,exports){
...
},{"../../config":23,"../../util":74,"../../watcher":78}],32:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../util":74}],33:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../transition/transition":69,"../../util":74}],34:[function(require,module,exports){
(function (process){
var _ = require('../../util')
...
},{"../../util":74,"../internal/style":32,"_process":2}],35:[function(require,module,exports){
module.exports = {
  bind: function () {
    var el = this.el
...
},{"../../util":74}],37:[function(require,module,exports){
(function (process){
var _ = require('../../util')
var FragmentFactory = require('../../fragment/factory')
...
},{"../../fragment/factory":52,"../../util":74,"_process":2}],38:[function(require,module,exports){
var _ = require('../../util')
var templateParser = require('../../parsers/template')
...
},{"../../parsers/template":65,"../../util":74}],39:[function(require,module,exports){
(function (process){
var _ = require('../../util')
var FragmentFactory = require('../../fragment/factory')
...
},{"../../fragment/factory":52,"../../util":74,"_process":2}],40:[function(require,module,exports){
// text & html
...
},{"./bind":34,"./cloak":35,"./el":36,"./for":37,"./html":38,"./if":39,"./model":42,"./on":46,"./ref":47,"./show":48,"./text":49}],41:[function(require,module,exports){
var _ = require('../../../util')
...
},{"../../../util":74,"./checkbox":41,"./radio":43,"./select":44,"./text":45,"_process":2}],43:[function(require,module,exports){
var _ = require('../../../util')
...
},{"../../util":74,"_process":2}],47:[function(require,module,exports){
(function (process){
if (process.env.NODE_ENV !== 'production') {
  module.exports = {
    bind: function () {
...
},{"../../util":74,"_process":2}],48:[function(require,module,exports){
var _ = require('../../util')
var transition = require('../../transition')
...
},{"../../transition":67,"../../util":74}],49:[function(require,module,exports){
var _ = require('../../util')
...
},{"../directives/public/for":37,"../parsers/path":64,"../util":74}],51:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":74,"./array-filters":50}],52:[function(require,module,exports){
var _ = require('../util')
var compiler = require('../compiler')
var templateParser = require('../parsers/template')
...
},{"../cache":18,"../compiler":21,"../parsers/template":65,"../util":74,"./fragment":53}],53:[function(require,module,exports){
var _ = require('../util')
var transition = require('../transition')
...
},{"../transition":67,"../util":74}],54:[function(require,module,exports){
(function (process){
var _ = require('../util')
var inDoc = _.inDoc
var eventRE = /^v-on:|^@/
...
},{"../compiler":21,"../directive":24,"../util":74}],57:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../util":74,"_process":2}],58:[function(require,module,exports){
(function (process){
var _ = require('../util')
var compiler = require('../compiler')
...
},{"../compiler":21,"../observer":61,"../observer/dep":60,"../util":74,"../watcher":78,"_process":2}],59:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":74}],61:[function(require,module,exports){
var _ = require('../util')
var config = require('../config')
var Dep = require('./dep')
...
},{"../config":23,"../util":74,"./array":59,"./dep":60}],62:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":18,"../util":74}],63:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../cache":18,"../util":74,"./path":64,"_process":2}],64:[function(require,module,exports){
(function (process){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":18,"../util":74,"_process":2}],65:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":18,"../util":74}],66:[function(require,module,exports){
var Cache = require('../cache')
var config = require('../config')
...
},{"../cache":18,"../config":23,"./directive":62}],67:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":23,"_process":2}],72:[function(require,module,exports){
(function (process){
var _ = require('./index')
var config = require('../config')
var transition = require('../transition')
...
},{"../config":23,"../transition":67,"./index":74,"_process":2}],73:[function(require,module,exports){
...
},{"../config":23,"./index":74,"_process":2}],77:[function(require,module,exports){
(function (process){
var _ = require('./util')
var extend = _.extend
...
},{"./api/data":12,"./api/dom":13,"./api/events":14,"./api/global":15,"./api/lifecycle":16,"./directives/element":25,"./directives/public":40,"./filters":51,"./instance/events":54,"./instance/init":55,"./instance/lifecycle":56,"./instance/misc":57,"./instance/state":58,"./util":74,"_process":2}],78:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
var Dep = require('./observer/dep')
...
},{"./batcher":17,"./config":23,"./observer/dep":60,"./parsers/expression":63,"./util":74,"_process":2}],79:[function(require,module,exports){
'use strict';
...
var vm = new Vue({
    ...
    computed: {
        schoology_title: function schoology_title() {
    ...
    methods: {
        fileCopied: function fileCopied(data) {
        ...
        reportError: function reportError(data) {
            switch (data.type) {
                case 'user':
        ...
        fetchTemplateFiles: function fetchTemplateFiles() {
            var request = {
            ...
            this.$http.post('/api/assignments/gettemplatefiles', request, function (data, status, request) {
                this.$set('template_files', data);
                this.$set('fetching_template_files', false);
            });
        },
        getGradingGroups: function getGradingGroups() {
            this.$http.get('/api/sections/' + DriveCompanion.section.id + '/grading-groups', function (data) {
                this.$set('grading_groups', data);
            });
        },
        onUpdateEnrollments: function onUpdateEnrollments(e) {
            ...
            this.$http.put('/api/sections/' + DriveCompanion.section.id, update, function (users, status, request) {
                //this.$set('updating_section', false);
        ...
        onAssignments: function onAssignments() {
            this.show_asssignments_create_form = !this.show_asssignments_create_form;
        },

        getAssignments: function getAssignments() {
            this.$http.get('/api/sections/' + DriveCompanion.section.id + '/assignments', function (data) {
                this.$set('assignments', data);
            });
        },

        getAssignmentFiles: function getAssignmentFiles(id) {
            this.$set('selected_file', null);
            this.$http.get('/api/assignments/' + id + '/files', function (data) {
                this.$set('assignment_files', data);
                $('[data-toggle="tooltip"]').tooltip();
            });
        },

        getSchoologyAssignments: function getSchoologyAssignments() {
            this.$http.get('/api/sections/' + DriveCompanion.section.id + '/schoology-assignments', function (data) {
                this.$set('schoology_assignments', data);
            });
        },

        openAssignmentFile: function openAssignmentFile(file) {
            this.$set('selected_file', file);
        },

        onCreateAssignments: function onCreateAssignments(e) {
            e.preventDefault();
            ...
            this.$http.post('/api/assignments', request, function (data, status, request) {
...
},{"../../vendor/bootstrap-sass/assets/javascripts/bootstrap":80,"moment":1,"pusher-js":3,"vue":77,"vue-resource":5}],80:[function(require,module,exports){
'use strict';
