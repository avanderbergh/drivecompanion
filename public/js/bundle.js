...
new Vue({
    ...
    ready: function ready() {
        var pusher = new Pusher(DriveCompanion.PUSHER_KEY, {
            encrypted: true
        });
    ...
    methods: {
        ...
        fetchTemplateFiles: function fetchTemplateFiles() {
            var request = {
                ...
                'folder_id': DriveCompanion.section.templates_folder_id,
                'max_results': 100
            };
        ...
        onCreateAssignments: function onCreateAssignments(e) {
            e.preventDefault();
            this.show_asssignments_create_form = false;
...
},{"../vendor/bootstrap-sass/assets/javascripts/bootstrap":80,"jquery":1,"moment":3,"pusher-js":4,"vue":77,"vue-resource":6}],80:[function(require,module,exports){
/*!
